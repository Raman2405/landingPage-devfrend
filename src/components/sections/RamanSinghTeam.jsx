...
const teamMembers = [
  {
    ...
    specialties: ['Hair Coloring', 'Balayage', 'Updos'],
    social: {
      instagram: '#',
      facebook: '#',
      twitter: '#',
  ...
  },
  {
    ...
    role: 'Stylist',
    image: '/images/team.jpg',
    specialties: ['Haircuts', 'Styling', 'Extensions'],
    social: {
      instagram: '#',
      facebook: '#',
      twitter: '#',
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto">
            Our talented team of professional stylists is dedicated to helping you
            achieve your desired look with their expertise and creativity.
          </p>
        </div>
